...
function tisma_scripts() {
  ...
  wp_enqueue_style( 'tisma-Popup', $get_template_directory_uri.'/public/libs/@fancyapps/fancybox/jquery.fancybox.min.css' );
  wp_enqueue_style( 'tisma-slider', $get_template_directory_uri.'/public/libs/swiper/css/swiper.min.css' );
  wp_enqueue_style( 'tisma-main', $get_template_directory_uri.'/public/css/main.min.css' );

  wp_enqueue_script( 'tisma-inputmask', $get_template_directory_uri . '/public/libs/inputmask/jquery.inputmask.min.js', array('jquery'), '20200325', true );
  wp_enqueue_script( 'tisma-Popup', $get_template_directory_uri . '/public/libs/@fancyapps/fancybox/jquery.fancybox.min.js', array('jquery'), '20200325', true );
